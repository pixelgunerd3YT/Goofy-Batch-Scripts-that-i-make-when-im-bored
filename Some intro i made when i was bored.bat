...
chcp 65001 >nul
echo.
powershell -command "Write-Host '  	___      ___ ___  ________  _______   ________     ' -ForegroundColor Red"
powershell -command "Write-Host '	 |\  \    /  /|\  \|\   __  \|\  ___ \ |\   __  \    ' -ForegroundColor Red"
powershell -command "Write-Host '	 \ \  \  /  / | \  \ \  \|\  \ \   __/|\ \  \|\  \   ' -ForegroundColor Red"
